    ...
    <div class="intro-y col-span-12 lg:overflow-visible">
        ...
        @foreach($declarants as $declarant)
            <div class="mt-10 md:mt-2">
                ...
                <div
                    class="{{!$declarant->status ? 'bg-red-200':''}} hidden md:grid grid-cols-10 text-center text-sm md:pr-3 lg:px-0 py-5 xl:py-3 shadow-md font-medium bg-white rounded-lg">
                ...
                <span
                    class="absolute md:hidden right-50 top-10 -mt-4 -mr-4 ml-4 px-5 py-1 text-white rounded-full @if($declarant->status == 1) bg-theme-9 @elseif($declarant->status == 0) bg-theme-6 @endif rounded">@if($declarant->status == 1)
                        Свободно
                    @elseif($declarant->status == 0)
                        Зайнет
                    @endif</span>
                <div class="grid grid-cols-12 md:hidden shadow-md bg-white rounded-lg p-5 mt-4 font-medium">
                    ...
                    <div class="col-span-12 sm:col-span-8 mt-4">
                        <h1 style="padding-top: 6px;" class="text-lg">
                            <div class="font-medium">{{str_replace('_',' ',auth()->user()->name)}}</div>
                        </h1>
                    </div>
