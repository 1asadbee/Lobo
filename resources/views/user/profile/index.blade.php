...
@section('profile')
        ...
        <div class="modal__content">
            ...
            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                ...
                <div class="col-span-12">
                    ...
                    <input type="text" class="input w-full border mt-2 flex-1" placeholder="Новый Пароль">
                </div>
                <div class="col-span-12">
                    <label> Повторите Пароль </label>
                    <input type="text" class="input w-full border mt-2 flex-1" placeholder=" Повторите Пароль ">
                </div>
            </div>
            </form>
            <div class="px-5 py-3 text-right border-t border-gray-200">
    ...
    @if(auth()->user()->roles->contains(4))
        @include('user.profile.components.car_details')
    @endif

    @if((auth()->user()->roles->contains(5)))
        @include('user.profile.components.declarants')
    @endif
@section('js')
